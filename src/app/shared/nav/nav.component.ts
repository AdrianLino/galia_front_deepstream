  ...
  template: `
    <nav class="sticky top-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-700/50 shadow-lg px-6 py-3 flex items-center justify-between transition-all w-full h-16">
      ...
      <div class="flex items-center gap-3 relative">
        ...
        <a routerLink="/notifications" class="w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 text-gray-400 hover:text-white border border-gray-700 transition-colors">
